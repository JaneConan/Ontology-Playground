                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: 12, color: 'var(--text-tertiary)' }}>
                        {t('dataSources.propertiesMapped', { count: entity.properties.length })}
                      </div>
                    </div>
                  </div>
                  <div style={{ 
                    ...
                    {isSemanticModel ? t('dataSources.semanticModel') : t('dataSources.lakehouse')}
                  </div>
                </div>
